...
import { _ as _sfc_main$1 } from "./ProfileBannerOne-CvIXERdR.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="mx-sm-5" data-v-d6aff769>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_col, { cols: "12" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="d-sm-flex align-center mb-5" data-v-d6aff769${_scopeId2}><h3 class="text-h3 font-weight-semibold" data-v-d6aff769${_scopeId2}> Friends `);
                                          ...
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_v_avatar, { size: "80" }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<img${ssrRenderAttr("src", card.avatar)}${ssrRenderAttr("alt", card.avatar)} width="80" data-v-d6aff769${_scopeId7}>`);
                                                } else {
                                                  return [
                                                    createVNode("img", {
                                                      src: card.avatar,
                                            ...
                                            _push7(`<h4 class="text-h5 font-weight-semibold mt-3" data-v-d6aff769${_scopeId6}>${ssrInterpolate(card.name)}</h4><span class="text-truncate d-block gap-2 text-subtitle-2 font-weight-medium" data-v-d6aff769${_scopeId6}>${ssrInterpolate(card.role)}</span>`);
                                          } else {
                                            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/apps/userprofile/one/Projects.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Projects = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d6aff769"]]);
export {
  Projects as default
};
//# sourceMappingURL=Projects-ByDA2N28.js.map
