import { defineComponent, ref, resolveComponent, mergeProps, unref, useSSRContext, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, Fragment, renderList, computed, watch, withModifiers, createCommentVNode } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttr } from "vue/server-renderer";
import { d as defineStore, a as axiosServices, g as useDisplay } from "../server.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).selectedEmail) {
        ...
        _push(`</div><h5 class="text-20">${ssrInterpolate(unref(store).selectedEmail.subject)}</h5><div class="email-content"><p class="opacity-80">${unref(store).selectedEmail.emailContent ?? ""}</p></div>`);
...
//# sourceMappingURL=index-M-JtohCV.js.map
