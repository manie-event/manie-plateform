...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const checkPasswordRules = ref([
      ...
      (v) => v === registerForm.value.password || "Les mots de passe doivent être identiques"
    ]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_btn, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Je créer mon compte`);
                } else {
                  return [
                    createTextVNode("Je créer mon compte")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=RegisterForm-yDtuEVnE.js.map
