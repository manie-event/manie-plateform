...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, appendResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/destr/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/clementmoreno/Documents/manie-plateform/node_modules/unhead/dist/utils.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/clementmoreno/Documents/manie-plateform/.data/kv"}));
...
const _R6RihVFbpZmcfY0Kvj8hSMQO4PCTOJKF7bLNim73yVw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/clementmoreno/Documents/manie-plateform";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Manie - Facilite vos événements"};
...
const _LF_DVAbnWHTITmkbEe6KUxUUGStfcGSJfJ402BlSSQ = (nitroApp) => {
...
const plugins = [
  _R6RihVFbpZmcfY0Kvj8hSMQO4PCTOJKF7bLNim73yVw,
_LF_DVAbnWHTITmkbEe6KUxUUGStfcGSJfJ402BlSSQ
];
...
const getServerEntry = () => import('file:///Users/clementmoreno/Documents/manie-plateform/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/clementmoreno/Documents/manie-plateform/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_tqAgvr = () => Promise.resolve().then(function () { return renderer$1; });
