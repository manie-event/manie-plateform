import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, unref, resolveDynamicComponent, createBlock, openBlock, toDisplayString, Fragment, renderList, ref, createTextVNode, useSSRContext } from 'vue';
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h1 class="text-48 text-grey200 bannerTitle" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000"${_scopeId3}> Cr\xE9e ton \xE9v\xE9nement, de A \xE0 Z, comme un grand. </h1><p class="my-6 font-weight-semibold text-grey100 text-h5 mb-12" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000"${_scopeId3}> Imaginer, connecter, vivre. </p><div class="mt-6 d-sm-flex gap-3 justify-center" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000"${_scopeId3}>`);
                    _push4(ssrRenderComponent(_component_v_btn, {
                      ...
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`Je cr\xE9e mon \xE9v\xE8nement !`);
                        } else {
                          return [
                            createTextVNode("Je cr\xE9e mon \xE9v\xE8nement !")
                          ];
                        }
                      }),
                      _: 1
                    ...
                    return [
                      ...
                      }, " Cr\xE9e ton \xE9v\xE9nement, de A \xE0 Z, comme un grand. "),
                      createVNode("p", {
...
export { Footer as F, Revolution as R, _sfc_main$1 as _, _sfc_main as a, _sfc_main$3 as b, FrontPageMenu as c, demosMegamenu as d, appsMegamenu as e, productsSlider as p };
//# sourceMappingURL=aos-CPm6hj59.mjs.map
