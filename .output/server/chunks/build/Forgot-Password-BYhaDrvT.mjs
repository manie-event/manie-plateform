...
import { _ as _imports_0 } from './virtual_public-CZ8aUjQN.mjs';
import { _ as _sfc_main$1 } from './ResetForm-CY1w5cl8.mjs';
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_v_col, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="mt-xl-0 mt-5 mw-100"${_scopeId4}><h2 class="text-h2 font-weight-bold mb-2"${_scopeId4}> Vous avez oubli\xE9 votre mot de passe ? </h2><div class="text-14 mb-6 font-weight-medium mt-3 mb-8"${_scopeId4}> Entrez l&#39;email associ\xE9 \xE0 votre compte et nous vous enverrons un lien pour en saisir un nouveau. </div>`);
                              ...
                              _push5(ssrRenderComponent(_component_v_btn, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Revenir \xE0 la page d&#39;identification`);
                                  } else {
                                    return [
                                      createTextVNode("Revenir \xE0 la page d'identification")
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              return [
                                createVNode("div", { class: "mt-xl-0 mt-5 mw-100" }, [
                                  createVNode("h2", { class: "text-h2 font-weight-bold mb-2" }, " Vous avez oubli\xE9 votre mot de passe ? "),
                                  createVNode("div", { class: "text-14 mb-6 font-weight-medium mt-3 mb-8" }, " Entrez l'email associ\xE9 \xE0 votre compte et nous vous enverrons un lien pour en saisir un nouveau. "),
...
//# sourceMappingURL=Forgot-Password-BYhaDrvT.mjs.map
