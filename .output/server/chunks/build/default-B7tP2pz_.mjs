...
import { defineComponent, ref, resolveComponent, unref, mergeProps, withCtx, createVNode, withModifiers, createBlock, createCommentVNode, openBlock, createTextVNode, Fragment, renderList, shallowRef, watch, computed, watchEffect, getCurrentInstance, toDisplayString, resolveDirective, createSlots, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderClass, ssrRenderList, ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrGetDirectiveProps, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
import { ac as __nuxt_component_6, ad as injectHead, q as useTheme, g as useDisplay, ae as resolveUnrefHeadInput, D as _imports_0$1, a8 as flag1, a9 as flag4, aa as flag2, ab as flag3, u as useRouter$1 } from './server.mjs';
import { _ as _sfc_main$i } from './Logo-DggZ73XB.mjs';
import { s as searchSugg, l as languageDD, n as notifications, p as profileDD } from './headerData-B8k9Po-x.mjs';
...
import { _ as __nuxt_component_0$1 } from './nuxt-link-DZ3wFR7I.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_avatar, { size: "50" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", _imports_0$1)} width="50" alt="Mike Nielsen"${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: _imports_0$1,
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_avatar, { size: "90" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0$1)} width="90"${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0$1,
                  ...
                  _push3(ssrRenderComponent(_component_v_btn, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Me d\xE9connecter`);
                      } else {
                        return [
                          createTextVNode("Me d\xE9connecter")
                        ];
                      }
                    }),
                    _: 1
...
//# sourceMappingURL=default-B7tP2pz_.mjs.map
