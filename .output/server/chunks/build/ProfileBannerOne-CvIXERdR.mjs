...
import { D as _imports_0$1 } from './server.mjs';
                            ...
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_v_avatar, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<img${ssrRenderAttr("src", unref(_imports_0$1))} width="100" alt="Mathew" class="rounded-circle"${_scopeId5}>`);
...
//# sourceMappingURL=ProfileBannerOne-CvIXERdR.mjs.map
