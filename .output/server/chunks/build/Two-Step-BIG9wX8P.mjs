                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_v_col, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="mt-xl-0 mt-5 mw-100"${_scopeId4}><h2 class="text-h2 font-weight-bold mb-2"${_scopeId4}>Two Step Verification</h2><div class="text-14 mb-6 font-weight-medium mt-3 mb-8"${_scopeId4}> We sent a verification code to your mobile. Enter the code from the mobile in the field below. </div>`);
                              _push5(ssrRenderComponent(TwoStepForm, null, null, _parent5, _scopeId4));
                              _push5(`</div>`);
                            } else {
                              return [
                                createVNode("div", { class: "mt-xl-0 mt-5 mw-100" }, [
                                  createVNode("h2", { class: "text-h2 font-weight-bold mb-2" }, "Two Step Verification"),
                                  createVNode("div", { class: "text-14 mb-6 font-weight-medium mt-3 mb-8" }, " We sent a verification code to your mobile. Enter the code from the mobile in the field below. "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/auth/Two-Step.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Two-Step-BIG9wX8P.mjs.map
