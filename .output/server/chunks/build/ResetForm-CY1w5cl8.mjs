...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const passwordRules = ref([
      ...
      (v) => v.length >= 10 || "Votre nouveau mot de passe doit contenir au minimum 10 caract\xE8res"
    ]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_btn, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`R\xE9initialiser mon mot de passe`);
                } else {
                  return [
...
//# sourceMappingURL=ResetForm-CY1w5cl8.mjs.map
