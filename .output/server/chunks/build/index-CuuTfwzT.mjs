...
import { d as defineStore, h as user1, R as user2, l as user3, m as user4, j as img5$2, o as img6$1, a as axiosServices, $ as mock } from './server.mjs';
...
const useStudentsStore = defineStore({
  id: "Students",
  state: () => ({
    students: []
  }),
                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(_component_v_text_field, {
                                                        variant: "outlined",
                                                        "hide-details": "",
                                                        modelValue: editedItem.value.parents,
                                                        "onUpdate:modelValue": ($event) => editedItem.value.parents = $event,
                                                        label: "Parents"
                                                      }, null, _parent9, _scopeId8));
                                                    } else {
                                                      return [
                ...
                activator: withCtx(({ props }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_v_btn, mergeProps({
                      ...
                      flat: "",
                      ref_for: true
                    }, props, { to: "/school-pages/students/details" }), {
                      default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
            ...
            return [
              createVNode("thead", null, [
                createVNode("tr", null, [
                  ...
                  createVNode("th", { class: "text-subtitle-1 font-weight-semibold" }, "Parents"),
              ...
              createVNode("tbody", null, [
                (openBlock(true), createBlock(Fragment, null, renderList(filteredList.value, (item) => {
                  return openBlock(), createBlock("tr", {
                    ...
                    createVNode("td", { class: "text-subtitle-1 textSecondary text-no-wrap mt-1" }, toDisplayString(item.parents), 1),
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/school-pages/students/StudentTable.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const page = ref({ title: "Students Data" });
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/school-pages/students/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-CuuTfwzT.mjs.map
