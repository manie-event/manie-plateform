...
import { j as img5$2 } from './server.mjs';
import { S as StudentProgressReportData } from './detail_tables-DaSOttKS.mjs';
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_avatar, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", img5$2)} height="110" width="110"${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: img5$2,
...
//# sourceMappingURL=index-BpwkvCWG.mjs.map
