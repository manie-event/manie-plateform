...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const groupBy = ref([{ key: "status", order: "asc" }]);
    const headers = ref([
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_col, { cols: "12" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$2, { title: "Grouping" }, {
                      ...
                      if (_push4) {
                        ...
                        return [
                          createVNode(_component_v_data_table, {
                            ...
                            "sort-by": sortBy.value,
                            class: "border rounded-md"
                          }, null, 8, ["headers", "items", "group-by", "sort-by"])
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    createVNode(_sfc_main$2, { title: "Grouping" }, {
                      default: withCtx(() => [
                        createVNode(_component_v_data_table, {
                          "items-per-page": "5",
                          headers: headers.value,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/datatables/Grouping.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Grouping-1pL1_Me3.mjs.map
