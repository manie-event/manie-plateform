...
import { _ as _sfc_main$1 } from './RegisterForm-yDtuEVnE.mjs';
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_v_col, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="mt-xl-0 mt-5 mw-100"${_scopeId4}><h2 class="text-h2 font-weight-bold mb-2"${_scopeId4}>Bienvenue sur Manie !</h2><div class="text-h6 mb-6 font-weight-medium mt-3 mb-8"${_scopeId4}> Votre assistant \xE0 la cr\xE9ation et gestion d&#39;\xE9v\xE8nements </div>`);
                              _push5(ssrRenderComponent(_sfc_main$1, null, null, _parent5, _scopeId4));
                              _push5(`<h6 class="text-subtitle-1 text-grey100 d-flex align-center mt-6 font-weight-medium"${_scopeId4}> Vous avez d\xE9j\xE0 un compte? `);
                              _push5(ssrRenderComponent(_component_v_btn, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Identifiez-vous`);
                                  } else {
                                    return [
                                      createTextVNode("Identifiez-vous")
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              return [
                                createVNode("div", { class: "mt-xl-0 mt-5 mw-100" }, [
                                  ...
                                  createVNode("div", { class: "text-h6 mb-6 font-weight-medium mt-3 mb-8" }, " Votre assistant \xE0 la cr\xE9ation et gestion d'\xE9v\xE8nements "),
                                  createVNode(_sfc_main$1),
                                  createVNode("h6", { class: "text-subtitle-1 text-grey100 d-flex align-center mt-6 font-weight-medium" }, [
                                    createTextVNode(" Vous avez d\xE9j\xE0 un compte? "),
...
//# sourceMappingURL=Register-BIgZ9yw4.mjs.map
