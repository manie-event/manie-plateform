...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const page = ref({ title: "Solar icons" });
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_card_text, { class: "pa-5" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="pa-7 pt-0"${_scopeId4}><iframe src="https://icon-sets.iconify.design/solar/" title="Inline Frame Example" frameborder="0" width="100%" height="650"${_scopeId4}></iframe></div>`);
                            } else {
                              return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/icons/Solar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Solar-C0iOBsL1.mjs.map
