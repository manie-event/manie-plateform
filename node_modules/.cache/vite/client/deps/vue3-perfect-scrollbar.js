  ...
  methods: {
    create() {
      if (!(this.ps && this.$isServer)) {
        this.ps = new perfect_scrollbar_esm_default(this.$el, this.options);
...
var vue3_perfect_scrollbar_esm_default = index;
export {
  PerfectScrollbar$1 as PerfectScrollbar,
  vue3_perfect_scrollbar_esm_default as default
};
