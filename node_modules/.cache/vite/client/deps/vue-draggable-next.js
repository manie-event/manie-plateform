...
function isChangeEvent(event) {
  return event && typeof event === "object" && ("added" in event || "removed" in event || "moved" in event);
}
function isMoveEvent(event) {
  return event && typeof event === "object" && "draggedContext" in event && "relatedContext" in event;
}
var DEFAULT_PROPS = {
  tag: "div",
  sort: true,
...
function validateProps(props) {
  ...
  if (props.animation && (props.animation < 0 || props.animation > 3e3)) {
