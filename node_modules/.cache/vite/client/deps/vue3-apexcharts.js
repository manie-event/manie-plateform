...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  `).concat(s, `
    ...
    return Y(y, [{ key: "dataLabelsCorrection", value: function(e, t, i, a, s, r, n) {
      var o = this.w, h = false, c = new M(this.ctx).getTextRects(i, n), d = c.width, g = c.height;
      ...
      if (o.globals.dataLabelsRects[a][p] !== void 0) {
        ...
        (e > b.x + b.width || t > b.y + b.height || t + g < b.y || e + d < b.x) && (h = true);
      }
      return (s === 0 || r) && (h = true), { x: e, y: t, textRects: c, drawnextLabel: h };
    ...
    return Y(y, [{ key: "getLabel", value: function(e, t, i, a) {
      var s = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], r = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : "12px", n = !(arguments.length > 6 && arguments[6] !== void 0) || arguments[6], o = this.w, h = e[a] === void 0 ? "" : e[a], c = h, d = o.globals.xLabelFormatter, g = o.config.xaxis.labels.formatter, p = false, f = new re(this.ctx), b = h;
    ...
    return Y(y, [{ key: "scaleSvgNode", value: function(e, t) {
      ...
      return new Promise(function(i) {
        ...
        if (window.canvg && P.isIE11()) {
          var c = window.canvg.Canvg.fromString(o, h, { ignoreClear: true, ignoreDimensions: true });
          c.start();
          var d = r.msToBlob();
          c.stop(), i({ blob: d });
        } else {
...
` : n, h = this.w;
    ...
    return Y(y, [{ key: "drawGridArea", value: function() {
      ...
      var t = e.i, i = e.x1, a = e.y1, s = e.x2, r = e.y2, n = e.xCount, o = e.parent, h = this.w, c = false, d = o.node.classList.contains("apexcharts-gridlines-horizontal"), g = h.config.grid.strokeDashArray, p = h.globals.barPadForNumericAxis;
      (a === 0 && r === 0 || i === 0 && s === 0) && (c = true), a === h.globals.gridHeight && r === h.globals.gridHeight && (c = true), !h.globals.isBarHorizontal || t !== 0 && t !== n - 1 || (c = true);
    ...
    return Y(y, [{ key: "niceScale", value: function(e, t) {
      ...
      i.yaxis.forEach(function(n, o) {
        ...
        i.series.forEach(function(g, p) {
          g.name === n.seriesName && (h = p, o !== p ? r.push({ index: p, similarIndex: o, alreadyExists: true }) : r.push({ index: p }));
        });
        var c = a[h], d = s[h];
    ...
    return Y(y, [{ key: "drawYaxis", value: function(e) {
      ...
      i.config.yaxis.length > 1 && (this.multipleYs = true), i.config.yaxis.map(function(o, h) {
...
`);
    ...
    return Y(t, [{ key: "init", value: function(i) {
      ...
      if (a.shiftKey ? (this.shiftWasPressed = true, n.enableZoomPanFromToolbar(h === "pan" ? "zoom" : "pan")) : this.shiftWasPressed && (n.enableZoomPanFromToolbar(h), this.shiftWasPressed = false), a.target) {
      ...
      var a = i.context, s = i.zoomtype, r = this.w, n = a, o = this.gridRect.getBoundingClientRect(), h = n.startX - 1, c = n.startY, d = false, g = false, p = n.clientX - o.left - h, f = n.clientY - o.top - c, b = {};
      return Math.abs(p + h) > r.globals.gridWidth ? p = r.globals.gridWidth - h : n.clientX - o.left < 0 && (p = h), h > n.clientX - o.left && (d = true, p = Math.abs(p)), c > n.clientY - o.top && (g = true, f = Math.abs(f)), b = s === "x" ? { x: d ? h - p : h, y: 0, width: p, height: r.globals.gridHeight } : s === "y" ? { x: 0, y: g ? c - f : c, width: r.globals.gridWidth, height: f } : { x: d ? h - p : h, y: g ? c - f : c, width: p, height: f }, n.drawSelectionRect(b), n.selectionDragging("resizing"), b;
      ...
      if (r.config.yaxis.forEach(function(k, S) {
        ...
        if (r.globals.zoomEnabled) {
          ...
          var u = { xaxis: w };
          r.config.chart.group || (u.yaxis = m), n.ctx.updateHelpers._updateOptions(u, false, n.w.config.chart.animations.dynamicAnimation.enabled), typeof r.config.chart.events.zoomed == "function" && h.zoomCallback(w, m);
    ...
    return Y(y, [{ key: "getAttr", value: function(e, t) {
      ...
      if (t.target.classList.contains("apexcharts-".concat(r, "-rect"))) {
        ...
        if (n.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: h, j: c, shared: false, e: t }), o.globals.capturedSeriesIndex = h, o.globals.capturedDataPointIndex = c, a = d + n.tooltipRect.ttWidth / 2 + p, s = g + n.tooltipRect.ttHeight / 2 - f / 2, n.tooltipPosition.moveXCrosshairs(d + p / 2), a > o.globals.gridWidth / 2 && (a = d - n.tooltipRect.ttWidth / 2 + p), n.w.config.tooltip.followCursor) {
    ...
    return Y(y, [{ key: "initVariables", value: function(e) {
      ...
      if (g.globals.previousPaths.length > 0 && (l = this.barCtx.getPreviousPath(h, d, false)), A = A + p.line(m, r) + p.line(w - n, r) + p.line(w - n, s) + (g.config.plotOptions.bar.borderRadiusApplication === "around" ? " Z" : " z"), l = l + p.line(m, s) + u + u + u + u + u + p.line(m, s) + (g.config.plotOptions.bar.borderRadiusApplication === "around" ? " Z" : " z"), this.shouldApplyRadius(h) && (A = p.roundPathCorners(A, g.config.plotOptions.bar.borderRadius)), g.config.chart.stacked) {
        var x = this.barCtx;
      ...
      g.globals.previousPaths.length > 0 && (l = this.barCtx.getPreviousPath(h, d, false));
      var u = p.line(s, w - n);
    ...
    return Y(t, [{ key: "draw", value: function(i, a, s) {
      ...
      i.y;
      var r = i.xDivision, n = i.barWidth, o = i.zeroH, h = i.strokeWidth, c = this.w, d = new M(this.ctx), g = a.i, p = a.j, f = true, b = c.config.plotOptions.candlestick.colors.upward, m = c.config.plotOptions.candlestick.colors.downward, w = "";
      ...
      return c.globals.previousPaths.length > 0 && (C = this.getPreviousPath(m, p, true)), S = [d.move(u, k) + d.line(u, k + n / 2) + d.line(A, k + n / 2) + d.line(A, k + n / 2 - n / 4) + d.line(A, k + n / 2 + n / 4) + d.line(A, k + n / 2) + d.line(u, k + n / 2) + d.line(u, k + n) + d.line(v, k + n) + d.line(v, k) + d.line(u + h / 2, k), d.move(v, k) + d.line(v, k + n) + d.line(x, k + n) + d.line(x, k + n / 2) + d.line(l, k + n / 2) + d.line(l, k + n - n / 4) + d.line(l, k + n / 4) + d.line(l, k + n / 2) + d.line(x, k + n / 2) + d.line(x, k) + d.line(v, k) + "z"], C += d.move(u, k), c.globals.isXNumeric || (s += r), { pathTo: S, pathFrom: C, x, y: s, barYPosition: k, color: f };
    ...
    return Y(y, [{ key: "draw", value: function(e) {
      ...
      var h = e.slice();
      t.config.yaxis[0].reversed && (o = true, h.reverse());
    ...
    return Y(y, [{ key: "draw", value: function(e) {
      ...
      }) : (n = o.getPiePath({ me: o, startAngle: p, angle: a, size: d }), r.isTrack || (h.globals.animationEnded = true), e.node.setAttribute("data:pathOrig", n), e.attr({ d: n, "stroke-width": o.strokeWidth }));
      ...
      var t = this.w, i = new we(this.ctx), a = new M(this.ctx), s = new nt(this.ctx), r = a.group(), n = a.group(), o = i.niceScale(0, Math.ceil(this.maxY), t.config.yaxis[0].tickAmount, 0, true), h = o.result.reverse(), c = o.result.length;
      this.maxY = o.niceMax;
      ...
      var a = this, s = this.w, r = s.globals.dom.baseEl.querySelector(".apexcharts-datalabels-group"), n = false, o = s.globals.dom.baseEl.getElementsByClassName("apexcharts-pie-area"), h = function(g) {
      ...
      if (h({ makeSliceOut: true, printLabel: false }), t.total.show && s.globals.series.length > 1)
        n && !t.total.showAlways ? h({ makeSliceOut: false, printLabel: true }) : this.printInnerLabels(t, t.total.label, t.total.formatter(s));
      else if (h({ makeSliceOut: false, printLabel: true }), !n)
    ...
    return Y(y, [{ key: "draw", value: function(e) {
      ...
      return t.globals.labels.forEach(function(r, n) {
        ...
        if (s[n]) {
          ...
          h.plotDataLabelsText({ x: c.newX, y: c.newY, text: d, textAnchor: c.textAnchor, i: n, j: n, parent: a, color: Array.isArray(i.style.colors) && i.style.colors[n] ? i.style.colors[n] : "#a8a8a8", dataLabelsConfig: X({ textAnchor: c.textAnchor, dropShadow: { enabled: false } }, i), offsetCorrection: false });
        }
      }), a;
  ...
  var be, Fe, Nt = function() {
    ...
    return Y(y, [{ key: "_updateOptions", value: function(e) {
      ...
      return new Promise(function(n) {
        var o = [t.ctx];
        s && (o = t.ctx.getSyncedCharts()), t.ctx.w.globals.isExecCalled && (o = [t.ctx], t.ctx.w.globals.isExecCalled = false), o.forEach(function(h, c) {
          var d = h.w;
          if (d.globals.shouldAnimate = a, i || (d.globals.resized = true, d.globals.dataChanged = true, a && h.series.getPreviousPaths()), e && U(e) === "object" && (h.config = new Le(e), e = q.extendArrayProps(h.config, e, d), h.w.globals.chartID !== t.ctx.w.globals.chartID && delete e.series, d.config = P.extend(d.config, e), r && (d.globals.lastXAxis = e.xaxis ? P.clone(e.xaxis) : [], d.globals.lastYAxis = e.yaxis ? P.clone(e.yaxis) : [], d.globals.initialConfig = P.extend({}, d.config), d.globals.initialSeries = P.clone(d.config.series), e.series))) {
      ...
      return new Promise(function(s) {
        var r, n = i.w;
        return n.globals.shouldAnimate = t, n.globals.dataChanged = true, t && i.ctx.series.getPreviousPaths(), n.globals.axisCharts ? ((r = e.map(function(o, h) {
  ...
  * Copyright (c) 2016 Wout Fierens; Licensed MIT */
  function() {
    ...
    SVG.extend(SVG.PathArray, { morph: function(s) {
      for (var r = this.value, n = this.parse(s), o = 0, h = 0, c = false, d = false; o !== false || h !== false; ) {
        var g;
        c = a(r, o !== false && o + 1), d = a(n, h !== false && h + 1), o === false && (o = (g = new SVG.PathArray(p.start).bbox()).height == 0 || g.width == 0 ? r.push(r[0]) - 1 : r.push(["M", g.x + g.width / 2, g.y + g.height / 2]) - 1), h === false && (h = (g = new SVG.PathArray(p.dest).bbox()).height == 0 || g.width == 0 ? n.push(n[0]) - 1 : n.push(["M", g.x + g.width / 2, g.y + g.height / 2]) - 1);
        var p = y(r, o, c, n, h, d);
        r = r.slice(0, o).concat(p.start, c === false ? [] : r.slice(c)), n = n.slice(0, h).concat(p.dest, d === false ? [] : n.slice(d)), o = c !== false && o + p.start.length, h = d !== false && h + p.dest.length;
      }
  ...
  function() {
    ...
    y.prototype.init = function(e, t) {
      ...
      if (typeof r == "function") {
        ...
        typeof h == "boolean" && (h = { x: h, y: h }), h.x === true ? this.el.x(a) : h.x !== false && this.el.x(h.x), h.y === true ? this.el.y(s) : h.y !== false && this.el.y(h.y);
      } else
...
.apexcharts-rangebar-goals-markers{
  pointer-events: none
      ...
      return n.globals.selection = void 0, e.series && (this.series.resetSeries(false, true, false), e.series.length && e.series[0].data && (e.series = e.series.map(function(o, h) {
...
vue3-apexcharts/dist/vue3-apexcharts.js:
  (*!
   * ApexCharts v3.45.2
