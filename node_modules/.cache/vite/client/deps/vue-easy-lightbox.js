...
import { defineComponent as e, createVNode as t, Fragment as o, ref as l, reactive as n, computed as a, watch as r, nextTick as i, onMounted as s, onBeforeUnmount as c, Teleport as u, Transition as d, isVNode as p, withModifiers as b, isRef as v } from "vue";
function m(e2, t2) {
  void 0 === t2 && (t2 = {});
  var o2 = t2.insertAt;
...
var g = "vel";
var f = e({ name: "SvgIcon", props: { type: { type: String, default: "" } }, setup: (e2) => () => t("svg", { class: `${g}-icon icon`, "aria-hidden": "true" }, [t("use", { "xlink:href": `#icon-${e2.type}` }, null)]) });
...
var H = e({ name: "VueEasyLightbox", props: { imgs: { type: [Array, String], default: () => "" }, visible: { type: Boolean, default: false }, index: { type: Number, default: 0 }, scrollDisabled: { type: Boolean, default: true }, escDisabled: { type: Boolean, default: false }, moveDisabled: { type: Boolean, default: false }, titleDisabled: { type: Boolean, default: false }, maskClosable: { type: Boolean, default: true }, teleport: { type: [String, Object], default: null }, swipeTolerance: { type: Number, default: 50 }, loop: { type: Boolean, default: false }, rtl: { type: Boolean, default: false }, zoomScale: { type: Number, default: 0.12 }, maxZoom: { type: Number, default: 3 }, minZoom: { type: Number, default: 0.1 }, rotateDisabled: { type: Boolean, default: false }, zoomDisabled: { type: Boolean, default: false }, pinchDisabled: { type: Boolean, default: false }, dblclickDisabled: { type: Boolean, default: false } }, emits: { hide: () => true, "on-error": (e2) => true, "on-prev": (e2, t2) => true, "on-next": (e2, t2) => true, "on-prev-click": (e2, t2) => true, "on-next-click": (e2, t2) => true, "on-index-change": (e2, t2) => true, "on-rotate": (e2) => true }, setup(e2, o2) {
  ...
  })(), x2 = l(e2.index), _2 = l(""), T2 = n({ scale: 1, lastScale: 1, rotateDeg: 0, top: 0, left: 0, initX: 0, initY: 0, lastX: 0, lastY: 0, touches: [] }), $2 = n({ loadError: false, loading: false, dragging: false, gesturing: false, wheeling: false }), I2 = a(() => {
  ...
  }), V = a(() => ({ cursor: $2.loadError ? "default" : e2.moveDisabled ? $2.dragging ? "grabbing" : "grab" : "move", top: `calc(50% + ${T2.top}px)`, left: `calc(50% + ${T2.left}px)`, transition: $2.dragging || $2.gesturing ? "none" : "", transform: `translate(-50%, -50%) scale(${T2.scale}) rotate(${T2.rotateDeg}deg)` })), Z = () => {
    p2("hide");
  }, q = () => {
    T2.scale = 1, T2.lastScale = 1, T2.rotateDeg = 0, T2.top = 0, T2.left = 0, $2.loadError = false, $2.dragging = false, $2.loading = true;
  }, U = (t2, o3) => {
    const l2 = x2.value;
    q(), x2.value = t2, I2.value[x2.value] === I2.value[t2] && i(() => {
      $2.loading = false;
  ...
  r(() => e2.index, (e3) => {
    ...
    if (t2) {
      ...
      if (0 === t3) return x2.value = 0, $2.loading = false, void i(() => $2.loadError = true);
  ...
  const ye = () => $2.loading ? v2.loading ? v2.loading({ key: "loading" }) : t(Y, { key: "img-loading" }, null) : $2.loadError ? v2.onerror ? v2.onerror({ key: "onerror" }) : t(B, { key: "img-on-error" }, null) : t("div", { class: `${g}-img-wrapper`, style: V.value, key: "img-wrapper" }, [t("img", { alt: P.value, ref: m2, draggable: "false", class: `${g}-img`, src: F2.value, onMousedown: ae, onMouseup: ie, onMousemove: re, onTouchstart: se, onTouchmove: ce, onTouchend: ue, onLoad: me, onDblclick: de, onDragstart: (e3) => {
    e3.preventDefault();
  } }, null)]), ze = () => {
    if (v2["prev-btn"]) return v2["prev-btn"]({ prev: G });
    if (I2.value.length <= 1) return;
    const o3 = !e2.loop && x2.value <= 0;
    return t("div", { role: "button", "aria-label": "previous image button", class: "btn__prev " + (o3 ? "disable" : ""), onClick: G }, [e2.rtl ? t(f, { type: "next" }, null) : t(f, { type: "prev" }, null)]);
  }, ke = () => {
    if (v2["next-btn"]) return v2["next-btn"]({ next: W });
    if (I2.value.length <= 1) return;
    const o3 = !e2.loop && x2.value >= I2.value.length - 1;
    return t("div", { role: "button", "aria-label": "next image button", class: "btn__next " + (o3 ? "disable" : ""), onClick: W }, [e2.rtl ? t(f, { type: "prev" }, null) : t(f, { type: "next" }, null)]);
  }, _e = () => {
    if (!(e2.titleDisabled || $2.loading || $2.loadError)) return v2.title ? v2.title({ currentImg: H2.value }) : N2.value ? t(X, null, { default: () => [N2.value] }) : void 0;
  }, De = () => {
    let o3;
    if (e2.visible) return t("div", { onTouchmove: k, class: [`${g}-modal`, e2.rtl ? "is-rtl" : ""], onClick: b(ve, ["self"]), onWheel: pe }, [t(E, null, null), t(d, { name: `${g}-fade`, mode: "out-in" }, j(o3 = ye()) ? o3 : { default: () => [o3] }), t("img", { style: "display:none;", src: F2.value, onError: fe, onLoad: ge }, null), t("div", { class: `${g}-btns-wrapper` }, [ze(), ke(), _e(), v2["close-btn"] ? v2["close-btn"]({ close: Z }) : t("div", { role: "button", "aria-label": "close image preview button", class: "btn__close", onClick: Z }, [t(f, { type: "close" }, null)]), v2.toolbar ? v2.toolbar({ toolbarMethods: { zoomIn: K, zoomOut: Q, rotate: te, rotateLeft: te, rotateRight: oe, resize: le }, zoomIn: K, zoomOut: Q, rotate: te, rotateLeft: te, rotateRight: oe, resize: le }) : t(C, { zoomIn: K, zoomOut: Q, resize: le, rotateLeft: te, rotateRight: oe, rotateDisabled: e2.rotateDisabled, zoomDisabled: e2.zoomDisabled }, null)])]);
  };
  return () => {
    let o3;
    if (e2.teleport) {
      let o4;
      return t(u, { to: e2.teleport }, { default: () => [t(d, { name: `${g}-fade` }, j(o4 = De()) ? o4 : { default: () => [o4] })] });
    }
    return t(d, { name: `${g}-fade` }, j(o3 = De()) ? o3 : { default: () => [o3] });
  };
} });
var F = function() {
  let e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { imgs: "" };
  const { imgs: t2 = "", initIndex: o2 = 0 } = e2, n2 = l(t2), a2 = l(o2), r2 = l(false), i2 = function() {
    let e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a2.value;
    a2.value = e3;
  };
  return { imgsRef: n2, indexRef: a2, visibleRef: r2, show: function() {
    let e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a2.value;
    "number" == typeof e3 ? i2(e3) : v(e3) && "number" == typeof e3.value ? i2(e3.value) : e3 instanceof Event && i2(a2.value), r2.value = true;
  }, onHide: () => {
    r2.value = false;
  }, changeIndex: i2 };
};
var N = Object.assign(H, { install: (e2) => {
