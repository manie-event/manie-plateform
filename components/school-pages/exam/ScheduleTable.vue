...
<template>
      ...
      <v-dialog v-model="dialog" max-width="500">
        ...
        <v-card>
          ...
          <div class="pa-4 d-flex justify-end gap-2">
            ...
            <v-btn
              color="primary"
              :disabled="editedItem.class == '' || editedItem.date == ''"
              @click="save"
              rounded="pill"
              >Save</v-btn
            >
    ...
    <v-dialog v-model="showscehdule" max-width="500">
      <v-card>
        ...
        <div class="pa-4 d-flex justify-end">
          <v-spacer></v-spacer>
          <v-btn color="error" class="px-4" @click="showscehdule = false" rounded="pill"
            >Cancel</v-btn
          >
        </div>
      </v-card>
  ...
  <div class="d-sm-flex justify-md-space-between align-center mt-3">
    <div class="text-subtitle-1 text-grey100">Showing 1 to 10 of 16 entries</div>
    <div>
      <v-pagination
        v-model="page1"
        rounded="circle"
