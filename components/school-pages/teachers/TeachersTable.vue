    ...
    <v-table class="mt-5">
      <thead>
        <tr>
          ...
          <th class="text-subtitle-1 font-weight-semibold">Subject</th>
      ...
      <tbody>
        <tr v-for="item in filteredList" :key="item.id">
          ...
          <td class="text-subtitle-1 textSecondary text-no-wrap mt-1">{{ item.subject }}</td>
          ...
          <td>
            <div class="d-flex align-center">
              ...
              <v-tooltip text="View Details">
                <template v-slot:activator="{ props }">
                  <v-btn icon flat v-bind="props" to="/school-pages/teachers/details">
