                ...
                <v-container class="py-0 max-width-1218">
                    <v-toolbar class="d-flex align-center">
                        ...
                        <div class="d-flex ms-xl-0 ms-auto">
                            <v-btn class="me-lg-0 me-3 d-md-flex d-none text-white px-6 transform-none custom-hover-primary bg-primary " rounded="pill"  size="large" flat href="/auth/login"  target="_blank"
