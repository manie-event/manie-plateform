    ...
    <v-container class="max-width-1218 position-relative">
      <v-row>
        <v-col cols="12" lg="5">
          ...
          <p class="text-grey100 py-6 text-17 lh-32 pe-lg-4 font-weight-medium">
            Pellentesque varius semper odio non pretium.
          </p>
          <div class="slide-counter d-xl-block d-none">
                  ...
                  <div class="d-flex ga-4 align-center justify-space-between rtl-reviews pt-4">
                    <div class="d-flex ga-4 align-center">
                      ...
                      <div>
                        ...
                        <p class="text-15 text-grey100">{{ card.subtitle }}</p>
                      </div>
                    </div>
                    <div
                      class="round-48 rounded-circle bg-primary d-flex justify-center align-center"
                    >
                      <img
