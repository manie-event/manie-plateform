...
<template>
  <v-row>
    <v-col cols="12">
      <v-label class="font-weight-medium mb-2" for="bvnm">Name</v-label>
      <v-text-field
        color="primary"
        variant="outlined"
        id="bvnm"
    ...
    <v-col cols="12">
      <v-label class="font-weight-medium mb-2" for="bvcmp">Company</v-label>
      <v-text-field
        color="primary"
        variant="outlined"
        type="text"
    ...
    <v-col cols="12">
      <v-label class="font-weight-medium mb-2" for="bvempl">Email</v-label>
      <v-text-field
        color="primary"
        variant="outlined"
        type="email"
    ...
    <v-col cols="12">
      <v-label class="font-weight-medium mb-2" for="bvph">Phone No</v-label>
      <v-text-field
        color="primary"
        variant="outlined"
        type="text"
    ...
    <v-col cols="12">
      <v-label class="font-weight-medium mb-2" for="bvmsg">Message</v-label>
      <v-textarea
        auto-grow
        variant="outlined"
