  ...
  <v-expansion-panels>
      ...
      <v-expansion-panel-text class="mt-4">
        <v-row>
          <v-col cols="12" md="6">
            <v-row class="align-center mb-3">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="font-weight-medium" for="clnm">Full Name</v-label>
              </v-col>
              <v-col cols="12" sm="9">
                <v-text-field
                  color="primary"
            ...
            <v-row class="align-center mb-3">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="font-weight-medium" for="cladd">Address</v-label>
              </v-col>
              <v-col cols="12" sm="9">
                <v-textarea
                  auto-grow
            ...
            <v-row class="align-center mb-3">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="font-weight-medium" for="clcity">City</v-label>
              </v-col>
              <v-col cols="12" sm="9">
                <v-text-field
                  color="primary"
            ...
            <v-row class="align-start">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="mt-sm-2 mt-0 font-weight-medium" for="claddtype"
                  >Address Type</v-label
                >
              </v-col>
              <v-col cols="12" sm="9">
          ...
          <v-col cols="12" md="6">
            <v-row class="align-center mb-3">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="font-weight-medium" for="clphn">Phone No</v-label>
              </v-col>
              <v-col cols="12" sm="9">
                <v-text-field
                  color="primary"
            ...
            <v-row class="align-center mb-3">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="font-weight-medium" for="clpc">Pincode</v-label>
              </v-col>
              <v-col cols="12" sm="9">
                <v-text-field
                  color="primary"
            ...
            <v-row class="align-center mb-3">
              <v-col cols="12" sm="3" class="pb-sm-3 pb-0 text-right">
                <v-label class="font-weight-medium" for="cllm">Landmark</v-label>
              </v-col>
              <v-col cols="12" sm="9">
                <v-text-field
                  color="primary"
    ...
    <v-expansion-panel elevation="10" class="mt-3">
      ...
      <v-expansion-panel-text class="mt-4">
        ...
        <v-row class="mt-4">
          <v-col cols="12" md="8">
            <v-label class="mb-2 font-weight-medium" for="clcn">Card Number</v-label>
            <v-text-field
              color="primary"
              variant="outlined"
              id="clcn"
            ...
            <v-row>
              <v-col cols="12" md="6">
                <v-label class="mb-2 font-weight-medium" for="clnmm">Name</v-label>
                <v-text-field
                  color="primary"
                  variant="outlined"
                  id="clnmm"
              ...
              <v-col cols="12" md="3" sm="6">
                <v-label class="mb-2 font-weight-medium" for="clexp">Exp. Date</v-label>
                <v-text-field
                  color="primary"
                  variant="outlined"
                  id="clexp"
              ...
              <v-col cols="12" md="3" sm="6">
                <v-label class="mb-2 font-weight-medium" for="clcvv">CVV Code</v-label>
                <v-text-field
                  color="primary"
                  variant="outlined"
                  id="clcvv"
