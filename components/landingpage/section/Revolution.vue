    ...
    <v-container class="maxWidth">
      <v-row class="justify-center">
        <v-col cols="12" md="9" class="text-center">
          <h1
            class="text-52 text-grey200 bannerTitle"
            data-aos="fade-up"
            data-aos-delay="400"
            data-aos-duration="1000"
          >
            Revolutionize your development with Powerful NuxtJs dashboard
          </h1>
          <p
          ...
          <div class="mt-5 mb-5">
            <v-row class="justify-center">
              <v-col cols="12" sm="12" md="auto" lg="auto">
                <div
                  class="bg-containerBg d-flex align-center px-6 rounded-pill"
                >
                  <img src="/images/landingpage/background/frameworks.svg" />
                </div>
              </v-col>
            </v-row>
          </div>
