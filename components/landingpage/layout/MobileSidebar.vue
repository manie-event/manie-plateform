    ...
    <div class="pt-6 lp-mobile-sidebar">
        ...
        <v-list class="right-sidebar py-0 px-2">
            <v-list-group value="Apps">
                ...
                <v-list-item class="px-6 pb-6 lp_wrapper">
                    <div class="mt-4">
                        <h5 class="text-h5">Different Demos</h5>
                        <h6 class="text-subtitle-1 mt-1">Included with the package</h6>
                        <v-row class="mt-3">
                            <v-col cols="12" lg="12" v-for="demo in demosMegamenu" :key="demo.img">
                                <div class="text-center position-relative">
                                    <div class="overflow-hidden rounded-md">
                                        <div class="megamenu">
                                            <img :src="demo.img" :alt="demo.img" class="w-100 rounded-md" />
                                            <v-btn class="bg-primary text-white position-absolute mx-sm-12 pr-3" flat
                                                target="_blank" rounded="pill" :href="demo.link">Live Preview</v-btn>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mt-8">
                            ...
                            <v-row class="mt-3">
                                <v-col cols="12" v-for="demo in appsMegamenu" :key="demo.img">
                                    <div class="text-center position-relative">
                                        <div class="overflow-hidden rounded-md">
                                            <div class="megamenu">
                                                <img :src="demo.img" :alt="demo.img" class="w-100 rounded-md" />
        ...
        <v-list class="py-0 px-2">
            <v-list-item rounded="md">
                <v-btn variant="text" class="custom-hover-primary px-0 text-left" flat
                    href="https://demos.wrappixel.com/premium-admin-templates/nuxtjs/spike-nuxtjs/docs/index.html" target="_blank">
                    <h5 class="text-subtitle-1">Documentation</h5>
                </v-btn>
            </v-list-item>
            <v-list-item class="mt-2" rounded="md">
                <v-btn class="custom-hover-primary bg-primary" rounded="pill" block flat href="/auth/login" target="_blank">Login</v-btn>
            </v-list-item>
        </v-list>
    </div>
</template>
