        ...
        <div v-for="list in recentTransaction" :key="list.title">
          <v-row class="d-flex mb-4">
            <v-col cols="3" sm="3" class="px-0 pt-0 pb-1 text-right">
              <h6 class="text-subtitle-1 text-grey200 text-no-wrap font-weight-medium pr-2">
                {{ list.title }}
              </h6>
            </v-col>
            ...
            <v-col cols="7" sm="8" class="pt-0 pb-1">
              <h6 v-if="list.boldtext" class="text-subtitle-1 text-grey200 font-weight-bold">
                {{ list.subtitle }}
              </h6>
              <h6 v-else class="text-subtitle-1 text-grey200 font-weight-medium">
                {{ list.subtitle }}
              </h6>
              <div class="mt-n1">
                <NuxtLink
