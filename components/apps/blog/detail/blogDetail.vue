    ...
    <v-col cols="12">
      <v-card elevation="10">
          ...
          <div class="d-flex align-center justify-space-between">
            ...
            <div v-if="post.createdAt">
              ...
              <span
                ...
                v-text="format(new Date(post.createdAt), 'E, MMM d')"
              ></span>
            </div>
          </div>
        </v-card-item>
        ...
        <div class="pa-6">
          ...
          <p class="my-4 text-body-1 text-10">
            ...
            alphabetical order, which makes it much easier for someone to find what they are looking
            for if it is something specific and they do not want to go through all the other sites
            and links as well. It allows you to start your bid at the bottom and slowly work your
            way to the top of the list.
          </p>
          <p class="my-4 text-body-1 text-10">
            Gigure out what it is or what it can do. MTA web directory is the simplest way in which
            one can bid on a link, or a few links if they wish to do so. The link directory on MTA
            displays all of the links it currently has, and does so in alphabetical order, which
            makes it much easier for someone to find what they are looking for if it is something
            specific and they do not want to go through all the other sites and links as well. It
      ...
      <v-card elevation="10" class="pa-6 mt-6" rounded="md">
        <h3 class="text-h4 mb-6">
          Comments <v-chip class="bg-primary" size="small" v-text="post.comments?.length"></v-chip>
        </h3>
