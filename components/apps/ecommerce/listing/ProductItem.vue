...
<template>
    <v-card elevation="10" class="rounded card-hover overflow-hidden bg-surface">
        <router-link :to="`/apps/ecommerce/producttwo/two/detail/${goto}`">
        ...
        <v-card-item class="pt-1">
            ...
            <div class="d-flex align-center justify-space-between mt-1">
                ...
                <ClientOnly><v-rating color="warning" half-increments size="small" v-model="rate" density="compact"> </v-rating></ClientOnly>
            </div>
        </v-card-item>
