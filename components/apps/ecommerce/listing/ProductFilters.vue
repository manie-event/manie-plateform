...
<template>
    <perfect-scrollbar class="overflow-y-hidden side_scroll">
    <v-sheet class="pa-4 pt-1">
        <v-expansion-panels v-model="panel" multiple>
            ...
            <v-expansion-panel elevation="0">
                ...
                <v-expansion-panel-text class="acco-body">
                    <ClientOnly><v-rating hover color="warning" v-model="selectRating" class="ma-2" density="compact"></v-rating></ClientOnly>
                </v-expansion-panel-text>
            </v-expansion-panel>
        </v-expansion-panels>
        <v-btn color="primary" @click="filterReset()"  block class="mt-5" rounded="pill">Reset Filters</v-btn>
    </v-sheet>
</perfect-scrollbar>
</template>
<style lang="scss">
