        ...
        <v-row class="d-flex flex-cols gap-3">
          <v-col cols="12">
            <v-label class="font-weight-medium mb-2"
              >Product Name <span class="text-error ms-1">*</span></v-label
            >
            <VTextField
              type="text"
    ...
    <v-card elevation="10" class="mb-6">
      <v-card-text>
        ...
        <v-row class="d-flex flex-cols gap-3">
          <v-col cols="12">
            <v-label class="font-weight-medium mb-2"
              >Base Price <span class="text-error ms-1">*</span></v-label
            >
            <VTextField
              type="text"
              value="199.99"
            ...
            <div v-if="discount == 'no-discount'">
              <v-row>
                <v-col cols="12" md="6" class="pt-0">
                  <v-label class="font-weight-medium mb-2"
                    >Tax Class <span class="text-error ms-1">*</span></v-label
                  >
                  <v-select
                    v-model="select"
                    :items="items"
                ...
                <v-col cols="12" md="6" class="pt-0">
                  <v-label class="font-weight-medium mb-2"
                    >VAT Amount (%) <span class="text-error ms-1">*</span></v-label
                  >
                  <VTextField
                    type="text"
                    placeholder="Product Name"
