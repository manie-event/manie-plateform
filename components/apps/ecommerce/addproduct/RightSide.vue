...
import { ref } from 'vue';
import preview from '/images/backgrounds/preview-img.png';
      ...
      <v-card elevation="10" class="mb-6">
        <v-card-item>
          <div class="d-flex align-center justify-space-between">
            ...
            <v-avatar
              size="12"
              v-if="select == 'Published'"
              class="bg-success rounded-circle"
            ></v-avatar>
            <v-avatar
              size="12"
              v-else-if="select == 'Draft'"
              class="bg-error rounded-circle"
            ></v-avatar>
            <v-avatar
              size="12"
              v-else-if="select == 'Scheduled'"
        ...
        <v-card-item>
          ...
          <div class="mt-5">
            ...
            <v-btn variant="tonal" color="primary"
              ><span class="text-20 me-1">+</span> Create New Category</v-btn
            >
          </div>
          <div class="mt-8">
