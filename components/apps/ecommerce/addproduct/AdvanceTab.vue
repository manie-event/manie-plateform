        ...
        <v-row>
          <v-col cols="12">
            <v-label class="font-weight-medium mb-2"
              >SKU <span class="text-error ms-1">*</span></v-label
            >
            <VTextField
              type="text"
          ...
          <v-col cols="12">
            <v-label class="font-weight-medium mb-2"
              >Barcode <span class="text-error ms-1">*</span></v-label
            >
            <VTextField
              type="text"
          ...
          <v-col cols="12" md="6">
            <v-label class="font-weight-medium mb-2"
              >Quantity <span class="text-error ms-1">*</span></v-label
            >
            ...
            <v-row>
              ...
              <v-col cols="12">
                <v-btn variant="tonal" color="primary"
                  ><span class="text-20 me-1">+</span> Add another variation</v-btn
                >
              </v-col>
            </v-row>
          </v-col>
