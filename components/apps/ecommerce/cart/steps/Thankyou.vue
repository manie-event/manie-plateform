...
import { ref } from 'vue';
import completed from '/images/products/payment-complete.svg';
</script>
...
<template>
  <v-card>
    <v-card-item class="py-8 text-center">
      ...
      <p class="text-medium-emphasis mt-3 mb-2">
      ...
      <small class="text-medium-emphasis"
        >If you have any query or questions regarding purchase items, then fell to get in contact
        us</small
      ><br />
      <span class="text-error">(555) 492-2175</span>
      <div class="d-sm-flex align-center justify-center gap-3 mt-5 mb-5">
        <v-btn color="primary" variant="tonal" to="/apps/ecommerce/productsone"
          >Continue to Shopping</v-btn
        >
